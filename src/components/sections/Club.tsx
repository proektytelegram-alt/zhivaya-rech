        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h2 className="font-display text-4xl md:text-5xl font-semibold leading-tight mb-6">
              Хочешь попробовать формат?{" "}
              <span className="text-primary">Приходи в клуб живой речи.</span>
            </h2>
            <p className="text-lg text-foreground/75 leading-relaxed mb-8">
              Раз в неделю мы собираемся, чтобы говорить — свободно, без
              оценок. Упражнения в парах, в кругу, на сцене. Здесь люди
              знакомятся, смеются, выступают и перестают бояться оценки.
              <br />
              <br />
              Лучший способ почувствовать наш подход вживую — ещё до того,
              как решишь идти на курс.
            </p>
