...
const faqs = [
  ...
  },
  {
    ...
    a: "У нас формат офлайн — никаких записей не будет. Если пропустишь — Денис после занятия коротко расскажет, что было, и пришлёт упражнение для самостоятельной отработки. Но мы не рекомендуем пропускать больше 1–2 занятий: каждая встреча — продолжение предыдущей, и выпадать из группы обидно прежде всего самому.",
  },
  {
  ...
  {
    q: "Есть ли гарантия?",
    a: "Если к 3-му занятию ты почувствуешь, что формат тебе не подходит — вернём деньги за оставшиеся занятия, без вопросов. Гарантий «ты станешь Стивом Джобсом за 6 недель» не даём — так не работает. Но честную практику и обратную связь на каждом занятии — гарантируем.",
  },
  {
