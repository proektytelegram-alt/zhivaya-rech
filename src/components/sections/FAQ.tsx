...
const faqs = [
  ...
  {
    q: "Есть ли гарантия?",
    a: "Если к 3-му занятию ты почувствуешь, что формат тебе не подходит — вернём деньги за оставшиеся занятия, без вопросов. Гарантий «ты станешь Стивом Джобсом за месяц» не даём — так не работает. Но честную практику и обратную связь на каждом занятии — гарантируем.",
  },
  {
